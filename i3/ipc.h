...
/*
 * This file was taken from the i3 project.
 * It is not included from /usr/include to detect breaking changes in the i3 ipc interface in case I3_IPC_MAGIC changes
 */
#pragma once
